...
// Ответ: Выведет "1122" - т.к. мы создали 2 класса и, поскольку, второй класс наследник первого, то для него
// автоматически создалось статическое свойство $x. Мы создали 2 экземпляра 2 разных классов и
// поочередно вызвали их методы foo. Создалось 2 статических свойства - по одному для каждого класса.
// Статическое свойство не распространяется на наследников, у наследников создается новое, выделяется новая память.
// Вопрос: Почему при каждом вызове метода статическое свойство не переопределяется?
// сначала же идет строка с присвоением этому свойству значения 0.. Правильно ли я понял, что это и есть специфика поведения
// статических свойств. Они определяются один раз при первом вызове и при последующих вызовах строка "static $x = 0;"
// просто игнорируется(при условии что данное свойство уже существует)?
